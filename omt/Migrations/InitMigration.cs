    ...
    public class InitMigration : IMigration
    {
        ...
        private void InitialiseDatabase(IEnumerable<IScript> initScripts, IScriptRunner scriptRunner, string schema, string tablespace)
        {
            ...
            else
            {
                ...
                Output.EmptyLine();
                Output.Warn("Note: omt assumes that the tablespace and schema share the same name, the versioning table will be created in tablespace '{0}'".FormatWith(schema));
